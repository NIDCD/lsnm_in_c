...
int main()
{
  ...
  float attn;
  int i,j,k;
  int rweights[maxsubjects][16];	/* 13 -> 16 */
  ...
  char *BASE = "/home/bhguest/sgihome/tchen/auditory_test";
  ...
  for(i=1; i<=n_subj; i++) /*loop saving connection weights for each subj*/
    {
      fscanf(infile,"%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d",&rweights[i][0],&rweights[i][1],&rweights[i][2],&rweights[i][3],&rweights[i][4],&rweights[i][5],&rweights[i][6],&rweights[i][7],&rweights[i][8],&rweights[i][9],&rweights[i][10],&rweights[i][11],&rweights[i][12],&rweights[i][13],&rweights[i][14],&rweights[i][15]);
    } /* end of n_subj loop */
  ...
  */
  ...
  for(k=1; k<=n_subj; k++)/* subject loop */
    ...
    /* create intra-hemisphere connections in RIGHT */
      fprintf(outfile,"%saltgenw_au %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n",bin,rweights[k][0],rweights[k][1],rweights[k][2],rweights[k][3],rweights[k][4],rweights[k][5],rweights[k][6],rweights[k][7],rweights[k][8],rweights[k][9],rweights[k][10],rweights[k][11],rweights[k][12],rweights[k][13],rweights[k][14],rweights[k][15]);
    /* create intra-hemisphere connections in LEFT (currently same as right)*/
      fprintf(outfile,"%saltgenw_L_au %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n",bin,rweights[k][0],rweights[k][1],rweights[k][2],rweights[k][3],rweights[k][4],rweights[k][5],rweights[k][6],rweights[k][7],rweights[k][8],rweights[k][9],rweights[k][10],rweights[k][11],rweights[k][12],rweights[k][13],rweights[k][14],rweights[k][15]);
