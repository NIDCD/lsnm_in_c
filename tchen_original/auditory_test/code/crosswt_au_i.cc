...
int main(int argc, char** argv)
{
  ...
  char *right[2][regions] = 
    {{"ea1u","ea1d","ea2u","ea2d","ea2c","estg","exfs","efd1","efd2","exfr","eted"},
     {"ia1u","ia1d","ia2u","ia2d","ia2c","istg","infs","ifd1","ifd2","infr","ited"}};

  char *left[2][regions] =  
    {{"eg1u","eg1d","eg2u","eg2d","eg2c","egtg","egfs","egd1","egd2","egfr","egte"}, 
     {"ig1u","ig1d","ig2u","ig2d","ig2c","igtg","igfs","igd1","igd2","igfr","igte"}};
