...
produces netgenC_L_au.in to be used by netgenC_L_au
...
int main(int argc,char **argv)
{
  ...
  char *BASE = "/home/bhguest/sgihome/tchen/auditory_test/code/";

  strcpy(Infile,BASE);
  strcpy(Outfile,BASE);
  strcat(Infile,"altgenw_L_au.in");
  strcat(Outfile,"netgenC_L_au.in");
