/* rev.  5/99,  TWL*/
/*crosswt_i.cc, use g++ compiler
read from an input file crosswt_i.in
The 1st line of crosswt_i.in specifies which version of netgen we want to
...
int main(int argc, char** argv)
{
  ...
  strcpy(Infile,BASE);
  strcat(Infile,"code/crosswt_i.in");
