/* generateC_L.cc 
written 07/18/03 by B. Warner
suffix x is related to row index, suffix y is related to column index

creates netgenC_L that is used in the R/L combined model mkbatchrlcom.cc
it generates the network in the "old" left hemisphere
...
netgen(char *Outfile, struct NetGenStruct Net)
{
  ...
  char *BASE ="/home/bhguest/brent/visual/code/netgenC_L.in";
