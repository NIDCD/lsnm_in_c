...
#
#
#   Author: Antonio Ulloa. Last updated by Antonio Ulloa on February 18 2015  
# **************************************************************************/
...
class SimGUI(QtGui.QMainWindow):
    ...
    def closeEvent(self, event):
        ...
        if reply == QtGui.QMessageBox.Yes:
            ...
            event.ignore()
#
# This is the end of main window class definition
#

# this is the beginning of the main LSNM simulation loop
def main():
