/* altgenw_L.cc  written 07/18/03 by B. Warner
produces netgenC_L.in to be used by netgenC_L
...
float capacity[40];
 ...
 const char *BASE= getenv("LSNM");
  ...
  strcpy(Infile,BASE);
  strcpy(Outfile,BASE);
  strcat(Infile,"code/altgenw_L.in");
  strcat(Outfile,"code/netgenC_L.in");
